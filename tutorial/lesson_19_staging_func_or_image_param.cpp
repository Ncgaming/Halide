// Halide tutorial lesson 19: Staging a Func or ImageParam
...
int main(int argc, char **argv) {
    ...
    // Func::in and ImageParam::in directives
    {
        ...
        // See figures/lesson_19_wrapper_local_g.mp4 for a
    ...
    {
        // In the schedule aboce, only the calls to 'f' made by 'g'
        ...
        // See figures/lesson_19_wrapper_global_g.mp4 and for a
        // visualization of what this did.
    }

    {
        ...
        g.realize(5, 5);
        // See figures/lesson_18_wrapper_unique.mp4 for a visualization.
    }

    {
        ...
        // several consumers, each scheduled differently.
...

    {
        ...
        // The execution strategy we want is to load an 8x8 tile of f
        // into registers, transpose it in-register, and then write it
        // out as an 8x8 tile of g. We will use Func::in to express this:
...

    {
        ...
        // Func into the same loop nest. Consider the following code:
        Func f("f_group"), g("g_group");
        f(x, y) = x + y;
        f(x, y) += x - y;
        g(x, y) = 2 * f(x, y);

        // If we schedule 'f' compute_root, all of its stages are
        // computed in separate loop nests:
        // for y:
        //   for x:
        //     f(x, y) = x + y
        // for y:
        ...
        // We can use Func::in to group those stages to be computed in the
        ...
        // consumer, which in this case is the wrapper f.in(g). This
        // therefore generates the following loop nest, which has
        // better locality:
